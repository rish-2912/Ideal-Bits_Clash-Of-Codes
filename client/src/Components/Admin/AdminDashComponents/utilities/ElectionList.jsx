...
const ElectionList = (props) => {
  ...
  return (
    <div>
      <div className="grid items-center justify-items-center sm:grid-cols-1 md:grid-cols-4 gap-4 mb-4 ">
        <div>
          <span className="bg-blue-100 text-cyan-800 py-1 px-3 rounded-full font-medium ">{props.name}</span>
        </div>
        <div>
          <span className="bg-blue-100 text-cyan-800 py-1 px-3 rounded-full font-medium ">{props.type}</span>
        </div>
        <div>
